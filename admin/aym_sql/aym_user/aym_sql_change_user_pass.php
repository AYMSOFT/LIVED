<?php # **************************** AYMCORE V: 14.0 ********************
# PROCEDIMIENTO PARA CAMBIAR LA CONTRASEÑA DE USUARIO
# © 2022, AYMSOFT SAS
# ADRIAN LOPEZ RODRIGUEZ OCT/10/2022 
	...
	#QUERY--> 
	$aym_sql = "CALL `AYM_SP_CHANGE_USER_PASS`(".$_SESSION['use_id'].",'".$_POST['use_pwd']."', '".$_POST['use_pwd1']."','".$_POST['aym_rec']."');";
	...
	if (!$aym_sql_change_user_pass = mysqli_query($link,$aym_sql)) {
		...
		mysqli_free_result($aym_sql_change_user_pass);
	}	
