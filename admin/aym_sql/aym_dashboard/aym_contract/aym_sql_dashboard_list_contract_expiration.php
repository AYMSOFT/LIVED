...
# ADRIAN LOPEZ RODRIGUEZ ENE/31/2017
	...
	# QUERY
    $aym_sql = "CALL `AYM_SP_DASHBOARD_LIST_CONTRACT_EXPIRATION`('".$_POST['com_id']."','".$fecha->{'start'}." 00:00:00','".$fecha->{'end'}." 23:59:59');"; 
    
	# QUERY --> LISTADO LOS REGISTROS 	
	if (!$aym_sql_dashboard_contract_expiration=mysqli_query($link,$aym_sql)) {
		# INCLUSIÓN --> COMPONENTE QUE MUESTRA LOS ERRORES DE SINTAXIS
		include_once $_SERVER['DOCUMENT_ROOT'].'/admin/aym_component/aym_message/aym_show_message_error.php';	
	} else {	
		$aym_num_rows = mysqli_num_rows($aym_sql_dashboard_contract_expiration);
 	}
	mysqli_close($link);
?>       