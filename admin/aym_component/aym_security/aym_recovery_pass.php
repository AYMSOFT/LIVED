...
# ADRIAN LOPEZ RODRIGUEZ ENE/31/2017
	...
	# PRELOADER
	include_once $_SERVER['DOCUMENT_ROOT'].'/admin/aym_common/aym_preloader.php';
	...
	include $_SERVER['DOCUMENT_ROOT'].'/admin/aym_sql/aym_security/aym_sql_recovery_pass.php'; if ($row_count > 0) {  # 0 --> SI SE PUDO AUTENTICAR
		...
		if ($mail_sent > 0 ) {
			...
			$ReturnStatus = 0;
		 	# MENSAJE
			$Msg = 'Sus datos han sido enviados a: '.$use_log.'';
			# REDIRECCION
			$aym_url="/admin/login";
