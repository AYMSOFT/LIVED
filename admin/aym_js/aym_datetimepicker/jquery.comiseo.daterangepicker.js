	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			presetRanges: [
				...
				{text: 'Mes actual', dateStart: function() { return moment().startOf('month') }, dateEnd: function() { return moment() } },
				...
				{text: 'Año actual', dateStart: function() { return moment().startOf('year') }, dateEnd: function() { return moment() } }
			],
